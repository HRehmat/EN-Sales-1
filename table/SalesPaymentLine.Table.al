table 14228911 "Sales Payment Line"
{
    ...
    fields
    {
        ...
        field(4; Type; Enum LineType)
        {
            ...
            begin
                ...
                if SalesPayment.Get("Document No.") then
                    ...
                    case Type of
                        Type::Order:
                            begin
                                ...
                                //ENReleaseSalesDoc.SetSkipPaymentLineUpdate(true);
        ...
        field(10; "Order Shipment Status"; Enum OrderShpt)
        {
    ...
    var
        ...
        ENReleaseSalesDoc: Codeunit "EN Sales-Post Event";
