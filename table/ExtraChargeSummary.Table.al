table 14229103 "Extra Charge Summary"
{
    ...
    fields
    {
        ...
        {
            AutoFormatType = 1;
            CalcFormula = Sum ("Purchase Line"."Line Amount" WHERE ("Purch. Order for Extra Charge" = FIELD ("Purchase Order No."),
                                                                   "Extra Charge Code" = FIELD ("Extra Charge Code")));
            Editable = false;
