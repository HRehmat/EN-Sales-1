table 14228882 Buffer
{
    ...
    procedure CalcTotals(var precDataBufferTmp: Record Buffer temporary; var precTotalBufferTmp: array[5] of Record Buffer temporary; var pbolFirst: array[5] of Boolean; var pbolLast: array[5] of Boolean)
    var
        lint: Integer;
        lrecCurrDataTmp: Record Buffer temporary;
    begin
        // <ES01360JB>
    ...
    procedure ClearBuffer(var precTotalBufferTmp: array[5] of Record Buffer temporary; pint: Integer)
    begin
