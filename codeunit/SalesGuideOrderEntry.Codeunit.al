codeunit 14228900 "Sales Guide - Order Entry"
{
        ...
        repeat
            if SalesGuideOrderEntryT.Quantity > 0 then begin
                ...
                if SalesGuideOrderEntryT."Country/Region of Origin Code" <> '' then
                    NewSalesLine.Validate("Country/Region of Origin Code", SalesGuideOrderEntryT."Country/Region of Origin Code");
    ...
    var
        ...
        NextLineNum: Integer;
        SalesGuideOrderEntryT: Record "Sales Guide Order Entry";
}
