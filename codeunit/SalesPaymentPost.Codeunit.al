codeunit 14228910 "Sales Payment-Post"
{
    ...
    begin
        if (SalesPayment."Posting No." = '') then begin
            SalesPayment."Posting No. Series" := SalesSetup."Posted Sales Payment Nos.";
    ...
    begin
        PaymentMethod.TestField(PaymentMethod."Cash Tender Method", IsCash);
