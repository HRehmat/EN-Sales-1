codeunit 14229120 "Repack-Post"
{
    ...
    begin
        ...
        ItemJnlLine."Order Type Ext" := ItemJnlLine."Order Type Ext"::Repack;
        ...
        case RepackLine.Type of
            RepackLine.Type::Item:
                begin
                    ...
                    TempItemJnlLine."Order Type Ext" := TempItemJnlLine."Order Type Ext"::Repack;
                    ...
                    TotalCost += TempItemJnlLine."Unit Cost" * TempItemJnlLine.GetCostingQty(TempItemJnlLine.FieldNo(Quantity));
                end;
            ...
            RepackLine.Type::Resource:
                begin
                    ...
                    TempResJnlLine."Order Type Ext" := TempResJnlLine."Order Type Ext"::Repack;
