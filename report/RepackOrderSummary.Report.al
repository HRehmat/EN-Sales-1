report 14229121 "Repack Order Summary"
{
    ...
    dataset
    {
        dataitem("Repack Order"; "Repack Order")
        {
            ...
            begin
                ...
                ItemLedger.SetRange("Order Type", ItemLedger."Order Type Ext"::Repack);

                ResLedger.SetCurrentKey("Order Type", "Order No.", "Order Line No.");
                ResLedger.SetRange("Order Type", ResLedger."Order Type Ext"::Repack);
            end;
        }
    }
