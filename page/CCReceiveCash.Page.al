page 14228883 "C&C Receive Cash"
{
    DeleteAllowed = false;
    InsertAllowed = false;
    ...
    begin
        ...
        if (grecUserSetup.IsEmpty) or (grecUserSetup."CC Cash Journal Template" = '') then begin
            ...
            Payment.SetRange("Journal Batch Name", grecSalesAndRecSetup."C&C Cash Journal Batch");
        end
        else begin
            Payment.SetRange("Journal Template Name", grecUserSetup."CC Cash Journal Template");
            Payment.SetRange("Journal Batch Name", grecUserSetup."CC Cash Journal Batch");
        end;
        ...
        if not Payment.FindFirst then begin
            ...
            if (grecUserSetup.IsEmpty) or (grecUserSetup."CC Cash Journal Template" = '') then begin
                Payment.SetRange("Journal Template Name", grecSalesAndRecSetup."C&C Cash Journal Template");
                Payment.SetRange("Journal Batch Name", grecSalesAndRecSetup."C&C Cash Journal Batch");
                Payment."Journal Template Name" := grecSalesAndRecSetup."C&C Cash Journal Batch";
                Payment."Journal Batch Name" := grecSalesAndRecSetup."C&C Cash Journal Batch";
            end
            else begin
                Payment.SetRange("Journal Template Name", grecUserSetup."CC Cash Journal Template");
                Payment.SetRange("Journal Batch Name", grecUserSetup."CC Cash Journal Batch");
                Payment."Journal Template Name" := grecUserSetup."CC Cash Journal Template";
                Payment."Journal Batch Name" := grecUserSetup."CC Cash Journal Batch";
        ...
        if (grecUserSetup.IsEmpty) or (grecUserSetup."CC Cash Journal Template" = '') then begin
            GenJnlTemplate.Get(grecSalesAndRecSetup."C&C Cash Journal Template");
            GenJnlTemplate.Get(grecSalesAndRecSetup."C&C Cash Journal Batch");
        end
        else begin
            GenJnlTemplate.Get(grecUserSetup."CC Cash Journal Template");

            GenJnlBatch.Get(grecUserSetup."CC Cash Journal Template", grecUserSetup."CC Cash Journal Batch");
        end;
    ...
    begin
        ...
        if (grecUserSetup.IsEmpty) or (grecUserSetup."CC Cash Journal Template" = '') then begin
            lPayment.SetRange("Journal Template Name", grecSalesAndRecSetup."C&C Cash Journal Template");
            lPayment.SetRange("Journal Batch Name", grecSalesAndRecSetup."C&C Cash Journal Batch");
        end else begin
            lPayment.SetRange("Journal Template Name", grecUserSetup."CC Cash Journal Template");
            lPayment.SetRange("Journal Batch Name", grecUserSetup."CC Cash Journal Batch");
        end;
