page 14228886 "Customer Number"
{
        ...
        area(content)
        {
            ...
            field(ShipToCode; ShipToCode)
            {
                ...
                var
                    ...
                    lfrmUDFShipTo: Page "Ship-To Addresses";
                begin
                    ...
                    ShiptoAdd.SetFilter("Cash and Carry Location", gcodUserSalesLocFilter);
                    ...
                    if not ShiptoAdd.FindFirst then
                        Error(Text001, CustNo, grecUserSetup."Sales Location Filter", UserId);  // Is this really an error?
    ...
    begin
        ...
        gcodUserSalesLocFilter := grecUserSetup."Sales Location Filter";
