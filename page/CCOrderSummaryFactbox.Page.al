page 14228882 "C&C Order Summary Factbox"
{
    Caption = 'Summary';
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            ...
            field("Cash Applied (Current)"; "Cash Applied (Current)")
            {
            ...
            field("Cash Applied (Other)"; "Cash Applied (Other)")
            {
    ...
    begin
        Change := "Cash Tendered" - "Cash Applied (Current)" - "Cash Applied (Other)";
    end;
    ...
    begin
        ...
        Clear(lrecCustomer);
        if lrecCustomer.Get("Bill-to Customer No.") then begin
            DueDate := Today - lrecCustomer."Credit Grace Period (Days)";
