page 14228880 "Sales Order C&C Card"
{
    ...
    SourceTableView = WHERE("Document Type" = FILTER(Order), "Cash & Carry" = CONST(true));
    layout
    {
        area(content)
        {
            ...
            part(SalesLines; "Sales Order Sub C&C YOG")
            {
        ...
        area(factboxes)
        {
            part(CnCOrderSummaryFactbox; "C&C Order Summary Factbox")
            {
                ShowFilter = false;
            ...
            group("O&rder")
            {
                ...
                action("New Order")
                {
                    ...
                    var
                        ...
                        CustNoForm: Page "Customer Number";
                        CustNo: Code[20];
                        lcodShipTo: Code[10];
                ...
                action("Customer Balance to date")
                {
                    ...
                    trigger OnAction()
                    var
                        CustBalToDateReport: Report "Customer - Balance to Date Ext";
                    begin
        ...
        area(processing)
        {
            group(Functions)
            {
                ...
                action("Total Order")
                {
                    ...
                    trigger OnAction()
                    var
                        lpagCnCReceiveCash: Page "C&C Receive Cash";
            ...
            group(Authorize)
            {
                ...
                {
                    Caption = 'Display Signature';
                    Image = View;
                    Promoted = true;
                    PromotedCategory = Category4;
                    RunObject = Page "Signature Display";
                }
            }
            group("P&osting")
            {
    ...
    var
        ...
        lcduCreateIJ: Codeunit YOGCustomJFFunctions;
        gcduYOGFunctions: Codeunit YOGCustomJFFunctions;
        lpagCustSalesHistory: Page "Cust. Sales History";
    ...
    begin
        ...
        if (
        ("Amount Including VAT" <> "Cash vs Amount Including Tax")
        ) then begin
