page 14228900 "Sales Guide Order Entry Page"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Sell-to Customer No."; "Sell-to Customer No.")
                {
                    ...
                    trigger OnValidate()
                    begin
                        CashDrawerCheck;           //JA 06-26-2010

                        if DirectCustomer.Get("Sell-to Customer No.") then
                            if DirectCustomer."Direct Customer" then
            ...
            part("Sales Order Guide Lines"; "Sales Order Guide Subpage")
            {
                Caption = 'Items';
            ...
            part(SalesLines; "Sales Order Lines Subpage1")
            {
        ...
        area(processing)
        {
            ...
            action("&Order Items")
            {
                ...
                begin
                    ...
                    UserSetupL.Get(UserId);
                    if UserSetupL."Display All Items" then
                        IsDisplayAll := true;
                    //>>TMS1.01
    ...
    begin
        ...
        if SalesLine."Price After Sale" = true then begin
            SalesLine.SetRange("Document Type", 1);
            SalesLine.SetRange("Document No.", Rec."No.");
            SalesLine.SetRange("Price After Sale", false);
    ...
    var
        ...
        SlsOrderGuideOrdEntry: Record "Sales Guide Order Entry";
        DirectCustomer: Record Customer;
        Text50000: Label 'Direct Customer %1 can not be entered here.';
        SalesGuide: Codeunit "Sales Guide - Order Entry";
        LoadItems: Report "Sales Guide Order Entry";
    ...
    var
        SalesGuideOrderEntry: Codeunit "Sales Guide - Order Entry";
    begin
    ...
    begin
        ...
        if UserSetupL.Get(UserID) then begin
            ...
            if (UserSetupL."Display All Items") and (not ForDay) and (UserSetupL."Display All Date" = 0D) then
                UserSetupL."Display All Items" := SetStatus;
            if ForDay then begin
                if SetStatus then
                    UserSetupL."Display All Date" := Today
                else
                    UserSetupL."Display All Date" := 0D;
    ...
    begin
        ...
        if UserSetupL.Get(UserId) then
            if UserSetupL."Display All Items" then begin
                if (UserSetupL."Display All Date" <> Today) and (UserSetupL."Display All Date" <> 0D) then begin
                    UserSetupL."Display All Date" := 0D;
                    UserSetupL."Display All Items" := false;
                    UserSetupL.Modify;
                    exit(false);
                end;
                exit(true);
    ...
    begin
        ...
        SalesLine.SetRange("Price After Sale", true);
        ...
        if CheckPriceAfterSales then begin
            ...
            SalesLine.SetRange("Price After Sale");
            if SalesLine.FindSet then
                repeat
                    if SalesLine."Price After Sale" = false then
                        Error('All line should be enabled for Price After Sales');
