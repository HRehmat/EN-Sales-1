page 14228901 "Sales Order Guide Subpage"
{

    Caption = 'Sales Order Guide Subform';
    InsertAllowed = false;
    PageType = ListPart;
    SourceTable = "Sales Guide Order Entry";
            ...
            repeater(Control1102603000)
            {
                ...
                field("Quantity To Order"; QtyToOrder)
                {
                    ...
                    begin
                        ...
                        SalesH.CashDrawerCheck;  //JA 03-15-2010
    ...
    var
        ...
        OrderGuideMgmt: Codeunit "Sales Guide - Order Entry";
        VariantCode: Code[10];
        ...
        SalesGuideOrderEntry1: Record "Sales Guide Order Entry";
        CustNo: Code[20];
    ...
    var
        ...
        sgoe: Record "Sales Guide Order Entry";
    begin
        //84732
        /* //tms1.00
