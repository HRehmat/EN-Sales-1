page 14228881 "Sales Order Sub C&C YOG"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Requested Order Qty."; "Requested Order Qty.")
                {
                    Caption = 'Breaking Quantity';

                    trigger OnValidate()
                    begin
                        RequestedOrderQtyOnAfterValida;
                    end;
                }
    ...
    begin
        ...
        ldecPct := Round(doTrackingExists("Quantity (Base)", lblnItemTracking));
    ...
    var
        ...
        StyleTxt: Text;
        gcduSecUOMMgt: Codeunit YOGCustomJFFunctions;
        gcduYOGFunctions: Codeunit YOGCustomJFFunctions;
        gcodTrackingStatus: Codeunit YOGCustomJFFunctions;
    ...
    begin
        ...
        exit(lrecItemUOM."Item UOM Size Code");
    end;
